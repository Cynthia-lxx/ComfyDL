...
_CAT_DESC_EN = {
    ...
    'd2l/_Legacy/NLP Models': 'Deprecated (soft-archived): Multi-Head Attention, Add & Norm, Transformer Encoder Block/Encoder',
...
_CAT_DESC_ZH = {
    ...
    'd2l/_Legacy/NLP Models': '已弃用（软归档）：Multi-Head Attention、Add & Norm、Transformer Encoder Block/Encoder',
